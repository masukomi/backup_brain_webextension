async function restorePrefs(){
    ...
    let storage = await browser.storage.local.get('backup_brain_url')
    ...
    storage = await browser.storage.local.get('show_notifications')
...
async function savePrefs(){
    ...
    await browser.storage.local.set(new_values);


    let stored_url = await browser.storage.local.get('backup_brain_url')
